# 0db9855b-a89f-4c58-bd52-72e42b228c7b implementation handoff

This archive is the source of truth for turning the design into production code. Start from `identidade-visual-sin-v2.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `identidade-visual-sin-v2.html`
...
- A single self-contained `identidade-visual-sin-v2.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `identidade-visual-sin-v2.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `identidade-visual-sin-v2.html`
- `identidade-visual-sin.html`
...
1. Inspect `identidade-visual-sin-v2.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
