...
async def list_contratos(
    ...
    return await contrato_service.get_contratos(db, skip=skip, limit=limit)
...
async def create_contrato(
    ...
    """Cria um novo contrato (Acesso: Engenheiro+)."""
...
async def update_contrato(
    ...
    """Atualiza um contrato existente (Acesso: Engenheiro+)."""
