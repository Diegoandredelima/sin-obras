# 91a938d8-3436-4e1c-b6a7-a62701d5d782 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `identidade-visual-sin-v3.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `identidade-visual-sin-v3.html`
...
- A single self-contained `identidade-visual-sin-v3.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `identidade-visual-sin-v3.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
1. Inspect `identidade-visual-sin-v3.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
