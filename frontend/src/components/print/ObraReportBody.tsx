...
/**
 * Conteúdo do documento de uma obra (sem PrintLayout), reutilizado tanto na
 * impressão individual (`ObraImpressao`) quanto na impressão em lote
 * (`ObrasLoteImpressao`).
 */
const ObraReportBody = ({ o, showTitulo = false }: { o: ObraDetalhe; showTitulo?: boolean }) => (
  <div className="space-y-6">
    ...
    <MarcosContratuais obraId={o.id} contratoId={o.contrato_id} />
